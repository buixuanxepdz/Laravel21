<aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img style="width: 40px;" src="/backend/dist/img/logolarvel.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light" style="color: orange ; font-weight: bold !important" >Laravel Shop</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="#" class="nav-link">
                            <i class="fas fa-tshirt" style="margin-right: 3px"></i>
                            <p>
                                Quản lý thương hiệu
                                <i class="right fas fa-angle-left"></i>
                            </p>
